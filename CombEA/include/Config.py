...
class Config:
	language = 'dbp_fb' # zh_en | ja_en | fr_en en_fr_15k_V1 en_de_15k_V1 dbp_wd_15k_V1 dbp_yg_15k_V1 fb_dbp
	# e1 = 'data-jape/' + language + '/ent_ids_1'
	# e2 = 'data-jape/' + language + '/ent_ids_2'
	# # r1 = 'data/' + language + '/rel_ids_1'
	# # r2 = 'data/' + language + '/rel_ids_2'
	# # a1 = 'data/' + language + '/training_attrs_1'
	# # a2 = 'data/' + language + '/training_attrs_2'
	# ill = 'data-jape/' + language + '/ref_ent_ids_all'
	# kg1 = 'data-jape/' + language + '/triples_1'
	# kg2 = 'data-jape/' + language + '/triples_2'

	e1 = 'data/' + language + '/ent_ids_1'
	e2 = 'data/' + language + '/ent_ids_2'
	e2_trans = 'data/' + language + '/ent_ids_2_name'
	r1 = 'data/' + language + '/rel_ids_1'
	r2 = 'data/' + language + '/rel_ids_2'
	# a1 = 'data/' + language + '/training_attrs_1'
	# a2 = 'data/' + language + '/training_attrs_2'
